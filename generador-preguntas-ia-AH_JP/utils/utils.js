// Selección automática de entorno (igual que en services.js)
const AI_ENV = process.env.AI_ENV || "home";

export const AI_API_URL =
    AI_ENV === "school"
        ? process.env.AI_API_URL_SCHOOL || "http://localhost:11434"
        : process.env.AI_API_URL_HOME || "https://jarvis.ieshlanz.es";
